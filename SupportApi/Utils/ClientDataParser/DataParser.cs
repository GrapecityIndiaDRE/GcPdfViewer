...
namespace SupportApi.Utils
{
    public class DataParser
    {
        ...
        /// <summary>
        /// Annotation object which was created or updated by current data parser.
        /// </summary>
        public AnnotationBase Annotation { get; internal set; }

        /// <summary>
        /// Field object which was created or updated by current data parser.
        /// </summary>
        public Field Field { get; internal set; }

        /// <summary>
        /// The widget object which was created or updated using the data parser.
        /// </summary>
        ...
        /// <summary>
        /// Annotation id. Note, id can be temporal for new annotations.
        /// </summary>
        public string id
        {
            get
        ...
        public string annotationName
        {
            get
            {
                if (annotationData.ContainsKey("annotationName"))
                    return annotationData["annotationName"];
                return "";
            }
        }
        ...
        * */
        ...
        /// <summary>
        /// Order index. Annotations should be sorted according order index. Value of -1 means order is not specified.
        /// </summary>
        ...
        public Color NonStrokeColor
        {
            get
            {
                ...
                {
                    // backward compatibility for appearanceColor property
        ...
        public bool ParseBool( string key, bool defaultValue = false)
        {
            ...
            if (data.ContainsKey(key))
            {
                ...
                {
                    if (!(data[key] is string) && data[key] is object)
                        return true;
        ...
        public static AnnotationsTabsOrder? ParseAnnotationsTabsOrder(string tabs)
        {
            ...
            {
                case "C":
                    return AnnotationsTabsOrder.ColumnOrder;
                case "R":
                    return AnnotationsTabsOrder.RowOrder;
                case "S":
                    return AnnotationsTabsOrder.StructureOrder;
                default:
                    return null;
            }
        }
        ...
        internal string getDefaultAppearanceString(Color? strokeColor = null, Color? nonStrokeColor = null)
        {
            ...
            {
                fontNamePart = $"/{fontName}"; //e.g.: "/Helv"
            }
