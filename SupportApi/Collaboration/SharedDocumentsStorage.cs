...
namespace SupportApi.Collaboration
{
    public class SharedDocumentsStorage
    {
        ...
        /// <summary>
        /// key - document id, value - SharedDocument
        /// </summary>
        ...
        /// <summary>
        /// Returns the shared document by document id.
        /// </summary>
        ...
        public async Task CleanupOldDocuments()
        {
            ...
            foreach (var pair in sharedDocumentsArray)
            {
                ...
                if (_collaborationStorage != null)
                {
                    // Cleanup memory for unused documents 
                    // only when document data is available in storage:
                    doc.DisposeCache();
                }
                if (lifeTimeHours > 0)
                {                    
