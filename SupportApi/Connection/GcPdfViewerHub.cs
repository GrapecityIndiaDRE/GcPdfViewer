...
namespace SupportApi.Connection
{
    ...
    public class GcPdfViewerHub : Hub
    {
...
#if WEB_FORMS
        /// <summary>
        /// Use this method in order to register GcPdfViewer transport layer from ASP.NET or OWIN Startup class.
        /// </summary>
        /// <example>
        ...
        /// <summary>
        /// Send push message to all connected clients.
        /// </summary>
        ...
        /// <summary>
        /// Send message to all clients  except the one which triggered the current invocation.
        /// </summary>
        /// <param name="message"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Send message to client who triggered the current invocation.
        /// </summary>
        /// <param name="message"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Send a message to all users of the shared document specified by the documentId argument.
        /// </summary>
        ...
        /// <summary>
        /// Returns user name for current connection.
        /// </summary>
        /// <returns></returns>
            ...
            try
            {
                ...
                switch (message.type)
                {
                    case ClientMessageOrRequestType.Reconnect:
                        GetCurrentClientConnection(message); // this will re-bind current connection.
                        break;
        ...
        /// <summary>
        /// Method is called when shared documents list for the user given by parameter <paramref name="userName"/> has been changed.
        /// </summary>
